                ...
                <div className='w-full lg:w-2/3'>
                  ...
                  <div className='mb-6'>
                    ...
                    <p className='text-xs text-black/60'>
                      ...
                      <a href='youtube.com' className='text-black hover:underline'>
                        Learn more
                      </a>
                    </p>
                  </div>
                  <div className='mb-6 grid grid-cols-1 lg:grid-cols-2 lg:gap-4'>
                    <Link classes='h-12 mb-4 border border-solid border-black/20 hover:bg-black/5 transition duration-200 rounded px-6 text-base font-semibold'>
                      Discard
                    </Link>
                    <Link classes='h-12 border border-solid border-black/20 transition duration-200 rounded px-6 text-base font-semibold '>
                      Post
                    </Link>
                  </div>
                </div>
