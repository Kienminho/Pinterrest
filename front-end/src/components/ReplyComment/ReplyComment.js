  ...
  return (
    <>
      <div className='reply__body flex gap-1.5'>
        ...
        <div className='creator-name reply__content flex flex-col text-dark_color'>
          <div className='font-bold'>{comment.author.name}</div>
          <div className='flex text-base gap-1'>
            <span className='font-semibold'>@{parentAuthor}</span>
      ...
      <div className='created-reply flex gap-5 px-16 items-center'>
        ...
        <div onClick={() => handleClick(comment._id)} className='cursor-pointer text-[#767676] text-[15px] font-medium'>
          {'Phản hồi'}
        </div>
      </div>
    </>
